...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="w-full py-20 bg-gray-900 text-gray-300 relative overflow-hidden"
    >
        ...
        >
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 shadow-2xl group-hover:shadow-3xl transition-all duration-300 group-hover:transform group-hover:scale-105">
                <div
                ...
                <div className="grid grid-cols-2 gap-4">
                  {category.skills.map((skill, skillIndex) => (
                    <motion.div
                      ...
                      className="flex flex-col items-center p-4 bg-gray-700/30 rounded-xl border border-gray-600/30 hover:border-gray-500/50 transition-all duration-300 group/skill"
                    >
                      <div className="mb-3 transform group-hover/skill:scale-110 transition-transform duration-300">
                        {skill.icon}
                      </div>
                      <span className="text-sm font-medium text-center text-gray-300 group-hover/skill:text-white transition-colors duration-300">
                        {skill.name}
                      </span>
                    </motion.div>
                  ))}
