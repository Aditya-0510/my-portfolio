        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-800 rounded-lg shadow-md mt-2">
            <div className="px-4 pt-2 pb-3 space-y-2">
              <Link href="#about" className="block text-white hover:text-blue-400 py-2">About</Link>
              <Link href="#projects" className="block text-white hover:text-blue-400 py-2">Projects</Link>
              <Link href="#skills" className="block text-white hover:text-blue-400 py-2">Skills</Link>
              <Link href="#contact" className="block text-white hover:text-blue-400 py-2">Contact</Link>
            </div>
          </div>
        )}
      </div>
