...
const About = () => {
  return (
    <section
      id="about"
      className="w-full py-20 bg-gradient-to-r from-gray-900 to-gray-800 text-gray-300"
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-blue-400">
          About Me
        </h2>
        <div className="md:flex items-center gap-8">
          ...
          <div className="md:w-2/3">
            ...
            <p className="text-lg mb-6 leading-relaxed">
              Outside of coding, I enjoy exploring new technologies, watching
              movies, playing sports and engaging in competitive programming.
              I’m always excited to work on meaningful projects and collaborate
